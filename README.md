...
### O0. Вступительная работа
Вывести фамилию и имя в формате "lastname.firstname".

### O1. Паттерн "Стратегия"
...
Создать класс, содержащий публичные, защищенные и приватные методы
(2-3 каждого вида) с параметрами, аннотировать любые из них.
...
Хордовые ← Млекопитающие ← (Насекомоядные ← Ежовые ← Ёж обыкновенный ; Хищные ← Кошачьи ← (Манул ; Рысь))
...
должны быть распределены соответственно ежи, манули и рыси из
SrcCollection
...
4.1.	При запуске программы выполняется чтение словаря в следующем формате: слово или выражение | перево
